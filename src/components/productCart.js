...
const handleAddToCart = () => { dispatch( addToCart( {productId: id,quantity: 1,} ) ); };
...
return (
  ...
  <h2 className="text-xs font-sans font-normal uppercase text-[#000080] tracking-widest mb-2"> {type} </h2>
  <p className="text-sm font-sans text-[#8d8d8d] leading-relaxed mb-2"> {description} </p>
  </div>
